...
const socials = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/102743052",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/people/EdAstra/61578541859796/",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-0">
            ...
            <div className="lg:col-span-4 lg:pr-10 lg:border-r lg:border-white/[0.06]">
              <Link href="/" className="inline-block mb-3">
                <Image src="/logo.png" alt="Ed-Astra" width={160} height={28} className="h-7 w-auto" />
              </Link>
              ...
              <div className="space-y-2.5">
                ...
                <a href="mailto:shreya.anand@edastra.in" className="flex items-center gap-2.5 group">
                  ...
                  <span className="text-sm text-gray-400 group-hover:text-emerald-400 transition-colors">shreya.anand@edastra.in</span>
                </a>

                <a href="https://wa.me/919980795229" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 group">
                  <svg className="w-4 h-4 text-emerald-400/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span className="text-sm text-gray-400 group-hover:text-emerald-400 transition-colors">+91 99807 95229</span>
                </a>
